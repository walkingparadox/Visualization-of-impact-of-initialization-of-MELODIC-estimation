...
# input original nifti data from ABIDE data set
...
n.comp = 80 # the number of components as 80 is from the estimation of melodic software
...
for (subject in 1:100) {
  ic_seed[[subject]]=readNIfTI(paste0('/cbis4/projects/R_hcp/results_mb6/sub-29298ica_result_100seeds/sub-29298_ses-ch1_task-rest_run-01_bold',subject,'.ica/melodic_IC.nii.gz'),reorient = FALSE)
