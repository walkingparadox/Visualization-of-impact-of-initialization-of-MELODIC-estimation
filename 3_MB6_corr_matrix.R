...
n.comp=159
corr_of_seed=matrix(rep(0,100*100*n.comp),ncol=n.comp)
dim(corr_of_seed)=c(100,100,n.comp)
...
plot_full<-function(p){
  pdf(file = paste0("/cbis4/projects/R_hcp/results_mb6/new_mb6_",p,"_corr_new.pdf"))
...
artifacts=c(1,2,5,6,8,10,11,18,20,22,23,29,30,31,35,36,39,40,45,46,47,52,54,62,69,70,98,103,133,147,148)
signal=c(3,4,7,12,13,14,15,16,19,21,27,33,34,43,48,49,51,53,55,56,57,58,59,60,65,66,67,71,73,74,76,78,80,83,88,89,90,96,99,100,106,113,119,121)
unknown=c(9,17,24:26,28,32,37,38,41,42,44,50,61,63,64,68,72,75,77,79,81,82,84:87,91:95,97,101,102,104,105,107:112,114:118,120,122:132,134:146,149:159)
...
plot_separate_<-function(min,data,p,n,name){
  pdf(file = paste0("/cbis4/projects/R_hcp/results_mb6/new_quantile",p,"_corr_mb6_",name[[n]],".pdf"))
...
lapply(c(list(c(choosed_matrix(67))),list(c(choosed_matrix(54))),list(c(choosed_matrix(16))),list(c(choosed_matrix(140))),list(c(choosed_matrix(144)))), range)
# calculate the lower limit of values for corrplot by choosed minimum of each correlations in the same class
min_high_corr=round(min(c(choosed_matrix(67),choosed_matrix(54))),digits = 2)-0.01
min_low_corr=round(min(c(choosed_matrix(16),choosed_matrix(140),choosed_matrix(144))),digits = 2)-0.01
...
lapply(c(67,54), plot_chosen,min=min_high_corr,func=choosed_matrix)
lapply(c(16,140,144), plot_chosen,min=min_low_corr,func=choosed_matrix)
# 67, 144 are signal
# 54, 16 are artifacts
